  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: "linear-gradient(135deg, rgba(18, 109, 57, 0.8) 0%, rgba(38, 193, 100, 0.6) 100%), url('https://images.unsplash.com/photo-1582719471384-894fbb16e074?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')"
        }}
      />
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          <span className="text-[#26C164]">Backed by Nature</span>,{" "}
        ...
        <Button 
          ...
          className={`bg-[#B85E0E] hover:bg-[#A0520C] text-white px-8 py-4 text-lg rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
